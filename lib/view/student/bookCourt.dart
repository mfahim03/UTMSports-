...
class _BookFacilityContent extends StatelessWidget {
  ...
  static const _maroonLight = Color(0xFFFCEEEE);

  @override
  Widget build(BuildContext context) {
    final body = _BookFacilityBody();
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    _icons[sport] ?? Icons.sports,
                    color:
                        selected ? Colors.white : const Color(0xFF800000),
                    size: 26,
                  ),
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Column(
              ...
              children: [
                Icon(
                  isBooked ? Icons.lock_rounded : Icons.sports_tennis,
                  size: 20,
                  color: isSelected
                      ? Colors.white
                      : isBooked
